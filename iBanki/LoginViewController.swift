...
class LoginViewController: UIViewController {
    ...
    private let signButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(signInTappedLogin), for: .touchUpInside)
...
extension LoginViewController {
    ...
    func setupLayout(){
        ...
        //ImageLogoView
            ...
            NSLayoutConstraint.activate([
                subtitleLabel.topAnchor.constraint(equalTo: logoImageView.bottomAnchor, constant: 25),
